...
All assets display substantial kurtosis (8.3–23.0), indicating distributions with heavier tails than the normal distribution (which is 3). This suggests that extreme returns occur more frequently than would be expected under normality. Skewness is generally close to zero, although slight positive and negative asymmetries are observed across individual assets.
...
Although violations occur throughout the testing period, they are not uniformly distributed over time. Instead, most violations are concentrated during periods of elevated market uncertainty, particularly throughout 2022 and between mid-2024 and start-2026. 
...
It should also be mentioned that several models had a higher violation rate duirng the beginning of 2021. However, this is largely due to the minimum number of observations in window required to have a value being set to 1 rather than having a constant window of 60 days. In ther words, the corresponding rate was high not because of larger number of violations, but rather because of smaller number of observations. 
